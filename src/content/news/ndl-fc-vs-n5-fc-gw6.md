...
The Game Changer period left a genuine imprint on this fixture, with the **3Play** and **1-on-1** activations generating **5** goals — **50%** of the match's total output.
...
NDL FC and N5 FC had locked horns **1 time** before this encounter, and the history books painted an intriguing picture. N5 FC held bragging rights with **1 win** to NDL FC's **0**, and **0** stalemates between them.
