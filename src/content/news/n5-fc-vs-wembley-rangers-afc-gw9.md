...
| 14′ | Callam Gardner | Wembley Rangers AFC |
...
The Game Changer period **took over this match**. With **7** of the **11** total goals coming during GC activations (64%), the modified rules were not a sideshow — they *were* the show.
...
N5 FC and Wembley Rangers AFC had locked horns **1 time** before this encounter, and the history books painted an intriguing picture. N5 FC had the historical edge with **1 win** to Wembley Rangers AFC's **0**, with **0 draws** completing the record.

| GW | Result |
|-----|--------|
| 4 | N5 FC 3-1 Wembley Rangers AFC |


| H2H Stat | N5 FC | Wembley Rangers AFC |
|----------|-------|---------------------|
| Wins | 1 | 0 |
| Draws | 0 | 0 |
| Goals Scored | 3 | 1 |
...
N5 FC dropped to **5th**, wembley rangers afc climbed to **4th**.
...
| Stat | N5 FC | Wembley Rangers AFC |
|------|-------|---------------------|
| Goals | 3 | 8 |
| GC Goals | 7 | 7 |
...
- The **5-goal margin** represented a statement victory, one of the most one-sided results of Gameweek 9
