...
**Timmy Abraham** led the charge for Prime FC, his **3 goals** a testament to the kind of ruthless finishing that makes him a nightmare for opposing defences.
...
This was the **maiden competitive meeting** between Rukkas FC and Prime FC — a historic first that will be recorded in the Baller League annals. Fresh rivalries are forged on nights like these.
...
Rukkas FC dropped to **11th**, prime fc stayed at **3rd**.
...
| Stat | Rukkas FC | Prime FC |
|------|-----------|----------|
| Goals | 3 | 8 |
| GC Goals | 6 | 6 |
| GC 1st Half (Plus One) | 4 | 4 |
...
- **6 of 11 goals (55%)** came during Game Changer activations
- The **5-goal margin** represented a statement victory, one of the most one-sided results of Gameweek 2
...
*Looking for more Gameweek 2 coverage? Check out the [full GW2 roundup](/roundup/2) for all 6 matches, stats, and analysis.*
