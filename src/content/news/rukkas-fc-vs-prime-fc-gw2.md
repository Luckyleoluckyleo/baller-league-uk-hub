...
The Game Changer period proved decisive in this match, with the Plus One and 1-on-1 activations combining for 6 goals — accounting for 55% of the match's total scoring.
...
With just **9 gameweeks remaining** in the regular season, every point was vital. Prime FC — 3rd before kick-off — are well placed in the Final Four race. 

---

## Head-to-Head History

This was the **first ever competitive meeting** between Rukkas FC and Prime FC — a historic occasion that adds a new chapter to the Baller League record books.
...
|------|-------------|-------------|--------|
| Rukkas FC | 6th | 11th | Rukkas FC dropped from 6th to 11th. |
