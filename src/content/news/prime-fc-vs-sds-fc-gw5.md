...
With just **6 gameweeks remaining** in the regular season, every point was vital. SDS FC — 2nd before kick-off — look strong contenders for the Final Four. 

---

## Head-to-Head History

This was the **first ever competitive meeting** between Prime FC and SDS FC — a historic occasion that adds a new chapter to the Baller League record books.
...
|------|-------------|-------------|--------|
| Prime FC | 5th | 8th | Prime FC dropped from 5th to 8th. |
| SDS FC | 2nd | 1st | SDS FC climbed from 2nd to 1st. |
